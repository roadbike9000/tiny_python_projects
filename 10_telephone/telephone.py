...
Date   : 2024-06-20
Purpose: randomly mutates some given text which may be given on the command line or in a file
"""
...
# --------------------------------------------------
def main():
    """randomly mutates some given text which may be given on the command line or in a file"""
